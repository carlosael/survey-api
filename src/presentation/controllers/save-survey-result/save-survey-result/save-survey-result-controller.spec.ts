...
import { SaveSurveyResultContoller } from './save-survey-result-controller'
...
const makeSut = (): SutTypes => {
  ...
  const sut = new SaveSurveyResultContoller(loadSurveyByIdStub, saveSurveyResultStub)
  return {
    loadSurveyByIdStub,
    sut,
